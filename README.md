...
- [ArduPilot/ardupilot_wiki](https://github.com/ArduPilot/ardupilot_wiki) - Repository for ArduPilot wiki issues and wiki-specific website infrastructure. (1 year ago)

#### 🔭 Latest releases I've contributed to

- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([5.0.0-RC1](https://github.com/iNavFlight/inav/releases/tag/5.0.0-RC1), 1 day ago) - INAV: Navigation-enabled flight control software
- [ArduCustom/ardupilot](https://github.com/ArduCustom/ardupilot) ([light-v10.2](https://github.com/ArduCustom/ardupilot/releases/tag/light-v10.2), 3 days ago) - ArduPilot custom branches
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ([1.16.0](https://github.com/louislam/uptime-kuma/releases/tag/1.16.0), 3 days ago) - A fancy self-hosted monitoring tool
- [ArduPilot/ardupilot](https://github.com/ArduPilot/ardupilot) ([Plane-4.2.1](https://github.com/ArduPilot/ardupilot/releases/tag/Plane-4.2.1), 6 days ago) - ArduPlane, ArduCopter, ArduRover, ArduSub source
