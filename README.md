...
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([5.0.0](https://github.com/iNavFlight/inav/releases/tag/5.0.0), 4 days ago) - INAV: Navigation-enabled flight control software
- [ArduPilot/ardupilot](https://github.com/ArduPilot/ardupilot) ([Plane-4.2.2](https://github.com/ArduPilot/ardupilot/releases/tag/Plane-4.2.2), 5 days ago) - ArduPlane, ArduCopter, ArduRover, ArduSub source
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ([1.17.1](https://github.com/louislam/uptime-kuma/releases/tag/1.17.1), 6 days ago) - A fancy self-hosted monitoring tool
