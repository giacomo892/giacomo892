...
- [ArduCustom/ardupilot](https://github.com/ArduCustom/ardupilot) ([custom-v6.1](https://github.com/ArduCustom/ardupilot/releases/tag/custom-v6.1), 1 week ago) - ArduPilot custom branches
- [iNavFlight/inav](https://github.com/iNavFlight/inav) ([4.0.0-RC1](https://github.com/iNavFlight/inav/releases/tag/4.0.0-RC1), 1 week ago) - INAV: Navigation-enabled flight control software
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ([1.10.2](https://github.com/louislam/uptime-kuma/releases/tag/1.10.2), 2 weeks ago) - A fancy self-hosted monitoring tool
- [ArduPilot/ardupilot](https://github.com/ArduPilot/ardupilot) ([ArduPlane-stable](https://github.com/ArduPilot/ardupilot/releases/tag/ArduPlane-stable), 1 month ago) - ArduPlane, ArduCopter, ArduRover, ArduSub source
